...
${OBJECTDIR}/src/lib/ACApi.o: src/lib/ACApi.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/ACApi.o src/lib/ACApi.c

${OBJECTDIR}/src/lib/jSon.o: src/lib/jSon.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/jSon.o src/lib/jSon.c

${OBJECTDIR}/src/lib/logger.o: src/lib/logger.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/logger.o src/lib/logger.c

${OBJECTDIR}/src/lib/pCarsDump.o: src/lib/pCarsDump.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/pCarsDump.o src/lib/pCarsDump.c

${OBJECTDIR}/src/lib/pcarsApi.o: src/lib/pcarsApi.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/pcarsApi.o src/lib/pcarsApi.c

${OBJECTDIR}/src/lib/restWS.o: src/lib/restWS.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/restWS.o src/lib/restWS.c

${OBJECTDIR}/src/lib/serial.o: src/lib/serial.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/serial.o src/lib/serial.c

${OBJECTDIR}/src/lib/serialwin.o: src/lib/serialwin.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/serialwin.o src/lib/serialwin.c

${OBJECTDIR}/src/lib/serversocket.o: src/lib/serversocket.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/serversocket.o src/lib/serversocket.c

${OBJECTDIR}/src/lib/simController.o: src/lib/simController.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/simController.o src/lib/simController.c

${OBJECTDIR}/src/lib/simSource.o: src/lib/simSource.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/simSource.o src/lib/simSource.c

${OBJECTDIR}/src/lib/stringutils.o: src/lib/stringutils.c 
	${MKDIR} -p ${OBJECTDIR}/src/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lib/stringutils.o src/lib/stringutils.c

${OBJECTDIR}/src/server/bsServer.o: src/server/bsServer.c 
	${MKDIR} -p ${OBJECTDIR}/src/server
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/server/bsServer.o src/server/bsServer.c
