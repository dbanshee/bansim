...
const char * LIB_PATH_VALUE   = "/cygdrive/c/GIT/BanSim/bansim-server/ext/src/libmicrohttpd-0.9.38/src/microhttpd/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/GIT/BanSim/bansim-server/ext/src/libmicrohttpd-0.9.38/src/microhttpd/.libs:/usr/local/lib:/usr/local/bin:";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/cygdrive/c/GIT/BanSim/bansim-server/ext/src/libmicrohttpd-0.9.38/src/", f);
  fputs ("microhttpd/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/GIT/BanSim/bansim-server/ext/src/libmicrohttpd-0.9.38/src", f);
  fputs ("/microhttpd/.libs:$PATH\"\n", f);
  fputs ("\n", f);
